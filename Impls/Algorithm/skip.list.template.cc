...
public:
  using value_type = T;
  using hash_type  = std::hash<value_t>;
  using key_type   = typename hash_t::result_type;
...
const typename skip_list<Value>::value_type skip_list<Value>::default_value =
  typename skip_list<Value>::value_type();
